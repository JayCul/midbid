...
|---|---|---|---|---|
| 2026-09-23 | First pilot connect attempt | A locked wallet surfaced as `APIError: Wallet is locked`, and a declined prompt read like a failure | Both are now stated as the step that fixes them, with no library prefix | `pending2` |
