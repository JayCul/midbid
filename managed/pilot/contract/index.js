...
(function (Role) {
  ...
  Role[Role['BUILDER'] = 1] = 'BUILDER';
  Role[Role['SELLER'] = 2] = 'SELLER';
  Role[Role['BIDDER'] = 3] = 'BIDDER';
})(Role || (Role = {}));
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      join: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`join: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const key_0 = args_1[1];
        const record_0 = args_1[2];
        const role_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('join',
                                     'argument 1 (as invoked from Typescript)',
                                     'pilot.compact line 40 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(role_0) === 'number' && role_0 >= 0 && role_0 <= 3)) {
          __compactRuntime.typeError('join',
                                     ...
                                     'pilot.compact line 40 char 1',
                                     'Enum<Role, TESTER, BUILDER, SELLER, BIDDER>',
                                     role_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(key_0).concat(_descriptor_2.toValue(record_0).concat(_descriptor_3.toValue(role_0))),
        ...
        const result_0 = this._join_0(context,
                                      partialProofData,
                                      key_0,
                                      record_0,
                                      role_0);
    ...
    this.impureCircuits = { join: this.circuits.join };
    this.provableCircuits = { join: this.circuits.join };
  }
  initialState(...args_0) {
    if (args_0.length !== 2) {
  ...
  _join_0(context, partialProofData, key_0, record_0, role_0) {
    __compactRuntime.assert(!_descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'this address has already joined');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
